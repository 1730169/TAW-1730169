              ...
              _c(
                ...
                [
                  ...
                  _c("CSelect", {
                    ...
                    on: {
                      "update:value": function($event) {
                        return _vm.$set(_vm.servicio, "doctor_id", $event)
                      }
                    },
                    model: {
                      value: _vm.servicio.doctor_id,
                      callback: function($$v) {
                        _vm.$set(_vm.servicio, "doctor_id", $$v)
                      },
                      expression: "servicio.doctor_id"
                    }
                  }),
                  _vm._v(" "),
                  _c("CInput", {
                  ...
                  _c("CInput", {
                    ...
                    model: {
                      value: _vm.servicio.costo,
                      callback: function($$v) {
                        _vm.$set(_vm.servicio, "costo", $$v)
                      },
                      expression: "servicio.costo"
                    }
                  }),
                  _vm._v(" "),
                  _c(
